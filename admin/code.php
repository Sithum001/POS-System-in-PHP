...
if (isset($_POST['updateProduct'])) {
   ...
   $product_id  =validate($_POST['product_id']);
     ...
     if (!$productData) {
      redirect('products.php','No such data found');
     }
  ...
  if ($name != '') {
    ...
    if ($emailCheck) {
      if (mysqli_num_rows($emailCheck)>0) {
        redirect('customers.php','Email Already used by the another user');
   ...
   {
     redirect('customers.php','Pease fill required fields');
  }
...
if (isset($_POST['updateCustomer'])) {
  ...
  if ($name != '') {
    ...
    if ($emailCheck) {
      if (mysqli_num_rows($emailCheck)>0) {
        redirect('customers-edit.php?id='.$customerId,'Email Already used by the another user');
   ...
   {
     redirect('customers-edit.php?id='.$customerId,'Pease fill required fields');
  }
