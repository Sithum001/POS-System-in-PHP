$(document).ready(function() {
  ...
  $(document).on('click' ,'.proceedToPlace',function() {
    ...
    if (payment_mode == '') {
      swal("Select Paymeny Mode" ,"Select your payment mode","warning");
      return false;
 ...
 $(document).on('click' ,'.saveCustomer',function() {
    ...
    if (c_name !='' && c_phone !='') {
      if ($.isNumeric(c_phone)) {
        ...
        swal("Enter VAlid Phone Number","","warnings");
      }
    } else {
      swal("Please Fill Requires Fields","","warnings");
    }
